...
/obj/item/gun/launcher/crossbow/psibow/use_before(mob/living/M, mob/living/user, target_zone)
...
/obj/item/gun/launcher/crossbow/psibow/afterattack(atom/target, mob/living/user, proximity)
